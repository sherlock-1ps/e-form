...
import { CheckBoxOutlined, Delete, ArrowDownward, ArrowForward, Add, DeleteOutlined } from '@mui/icons-material'
...
import AddOptionCheckboxDialog from '@/components/dialogs/form/AddOptionCheckboxDialog'
...
const CheckboxProperty = () => {
  ...
  return (
    <div>
      <BaseTitleProperty
        title='ตัวเลือก: หลายตัวเลือก'
        icon={<CheckBoxOutlined sx={{ width: '24px', height: '24px' }} />}
        item={selectedField}
      />
      <section
      ...
      >
            ...
            <IconButton
              ...
              onClick={() => {
                updateDetails(
                  ...
                  {
                    value: {
                      ...toolboxOptionMenu[1]?.config?.details?.value
                    }
                  }
                )
              }}
        ...
        <BaseButton
          ...
          onClick={() => {
            showDialog({
              id: 'AddOptionCheckboxDialog',
              component: <AddOptionCheckboxDialog id={'AddOptionCheckboxDialog'} data={result} />,
              size: 'md'
            })
          }}
        />
      ...
      <section className='flex-1 flex flex-col my-4 mx-6 gap-2 pb-3.5'>
        ...
        {result?.config?.details?.trigger?.isTrigger && (
          ...
          >
            {dictionary?.configureTriggerEvent} {dictionary?.configureTriggerEvent}
          </Button>
        )}
      </section>
    </div>
