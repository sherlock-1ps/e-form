...
const UploadPaymentImage = ({ setFileImg }: any) => {
  // States
          ...
          <div {...getRootProps({ className: 'dropzone' })}>
            ...
            <div className='flex items-center gap-2 text-center'>
              ...
              <div className='flex flex-col'>
                <Typography className='font-bold'>Upload Payment receipt</Typography>
                <Typography color='text.disabled'>PNG, JPG format, Up to 1MB</Typography>
              </div>
            </div>
          </div>
        )}
