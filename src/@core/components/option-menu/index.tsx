...
const OptionMenu = (props: OptionsMenuType & { customTrigger?: React.ReactNode }) => {
  // Props
  const { tooltipProps, icon, iconClassName, options, leftAlignMenu, iconButtonProps, customTrigger } = props
