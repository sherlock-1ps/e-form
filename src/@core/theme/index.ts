// Next Imports
import { Public_Sans, Inter, Poppins, Sarabun } from 'next/font/google'
...
const sarabun = Sarabun({ subsets: ['latin'], weight: ['300', '400', '500', '600', '700', '800'] })
...
const theme = (settings: Settings, mode: SystemMode, direction: Theme['direction']): Theme => {
  return {
    ...
    typography: typography(sarabun.style.fontFamily),
