    ...
    <div className='flex flex-col gap-6'>
        ...
        <CardContent>
          <div className='flex flex-col gap-6'>
            <div className='flex gap-2 '>
              ...
              {dictionary['invoice']?.invoiceID} : {invoiceId}
              </Typography>
            </div>
            <Grid item xs={12} sm className='flex flex-col sm:flex-row gap-1 items-center justify-between'>
              <div className='flex gap-2 items-center'>
                <Typography variant='h5'>{dictionary['invoice']?.invoice} January 2025</Typography>
      ...
      <Card className='min-w-[1136px] overflow-auto relative'>
        <CardContent>
          <div className='flex flex-col gap-6'>
            ...
            >
              <div className='flex flex-col justify-between'>
                <div className='flex gap-2 items-center'>
                  ...
                  <Typography variant='h4'>{dictionary['superAPI']}</Typography>
                </div>
                <Typography variant='h5'>{dictionary['invoice']?.invoice} January 2025</Typography>
              </div>
              <div className='flex flex-col justify-center items-end gap-2'>
                <div>
                  <Typography variant='h5'>{dictionary['invoice']?.invoice}: #11000</Typography>
                </div>
                <div className='flex flex-col items-end'>
                  <Typography>{dictionary['invoice']?.invoiceDate}: 11/03/2025</Typography>
                  <Typography>{dictionary['dateDue']}: 11/03/2025</Typography>
                </div>
              </div>
            </div>
            <div className='flex flex-col gap-2'>
              ...
              <div>
                ...
                <div className='flex gap-2 items-center'>
                  ...
                  <Typography variant='h6'>{dictionary['onePlayBet']}</Typography>
                </div>
                <div className='flex gap-2 items-center'>
                  <Typography variant='h6' color={'text.secondary'}>
                  {dictionary['totalDue']} :
            ...
            <div className='flex justify-between'>
              <div className='flex flex-col gap-1'>
                <div className='flex gap-2 items-center'>
                  <Typography variant='h6' color={'text.secondary'}>
                  {dictionary['invoice']?.salesPerson}:
                  </Typography>
                  <Typography variant='h6'>{dictionary['invoice']?.aeSuperAPIService}</Typography>
                </div>
                <Typography variant='h6'>{dictionary['invoice']?.thanksForYourBusiness}</Typography>
              </div>
            ...
            <div className='flex flex-col gap-6'>
              ...
              <div className='flex items-center justify-between'>
                <div className='flex gap-6'>
                  ...
                  <div className='flex flex-col gap-1'>
                    <Typography variant='h6' color={'text.secondary'}>
                    {dictionary['invoice']?.bank}
                    </Typography>
                    <Typography variant='h6'>{dictionary['invoice']?.kBank}</Typography>
                  </div>
                </div>
                <div className='flex flex-col gap-1'>
                  <Typography variant='h6' color={'text.secondary'}>
                  {dictionary['invoice']?.bankAccount}
                  </Typography>
                  <div className='flex gap-2 items-center'>
                    <Typography variant='h6'>321-0-98765-4 ({dictionary['onePlayBet']})</Typography>
                    <button className='flex item-center justify-center rounded-full'>
                      <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none'>
                        <path
                          d='M20.25 2.625H8.25C7.95163 2.625 7.66548 2.74353 7.4545 2.9545C7.24353 3.16548 7.125 3.45163 7.125 3.75V7.125H3.75C3.45163 7.125 3.16548 7.24353 2.9545 7.4545C2.74353 7.66548 2.625 7.95163 2.625 8.25V20.25C2.625 20.5484 2.74353 20.8345 2.9545 21.0455C3.16548 21.2565 3.45163 21.375 3.75 21.375H15.75C16.0484 21.375 16.3345 21.2565 16.5455 21.0455C16.7565 20.8345 16.875 20.5484 16.875 20.25V16.875H20.25C20.5484 16.875 20.8345 16.7565 21.0455 16.5455C21.2565 16.3345 21.375 16.0484 21.375 15.75V3.75C21.375 3.45163 21.2565 3.16548 21.0455 2.9545C20.8345 2.74353 20.5484 2.625 20.25 2.625ZM14.625 19.125H4.875V9.375H14.625V19.125ZM19.125 14.625H16.875V8.25C16.875 7.95163 16.7565 7.66548 16.5455 7.4545C16.3345 7.24353 16.0484 7.125 15.75 7.125H9.375V4.875H19.125V14.625Z'
          ...
          >
            <Typography className='font-bold text-[290px] text-success'>{dictionary['draft']}</Typography>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className='min-w-[1136px]  relative'>
        <CardContent>
          ...
          >
            <Typography className='font-bold text-[130px] text-success'>{dictionary['draft']}</Typography>
          </div>
        </CardContent>
      </Card>
    </div>
