...
import PopularGameComponent from './PopularGameComponent'
import PopularProviderComponent from './PopularProviderComponent'
import NewGameComponent from './NewGameComponent'
import GGROverviewComponent from './GGROverviewComponent'
import GGRProviderComponent from './GGRProviderComponent'
  ...
  return (
    <Grid container spacing={6}>
      ...
      <Grid item xs={12} md={6}>
        <GGROverviewComponent />
      </Grid>
      <Grid item xs={12} md={6}>
        <GGRProviderComponent />
      </Grid>
