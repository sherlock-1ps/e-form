...
const SelectedProviderTable = ({ data = [], page, pageSize, setPage, setPageSize, onStatusUpdated }: any) => {
                        ...
                        showDialog({
                          ...
                          component: (
                            <ConfirmAlert
                              ...
                              onClick={() => {
                                onStatusUpdated(row.original.game_credential_id, !row.original.is_enable)
                              }}
                            />
                          ),
                          size: 'sm'
