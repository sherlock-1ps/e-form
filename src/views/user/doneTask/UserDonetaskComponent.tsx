...
const UserDonetaskComponent = () => {
  ...
  const { data: workEndData } = useFetchWorkEndQueryOption(page, pageSize, Number(selectedWorkflow))
      ...
      <Card>
        <CardContent>
          <Grid container spacing={4}>
            ...
            <Grid item xs={12}>
              <UserDashboardTable
                projectTable={workEndData?.result?.data || []}
                page={page}
                pageSize={pageSize}
                setPage={setPage}
                setPageSize={setPageSize}
                count={workEndData?.result?.total}
...
export default UserDonetaskComponent
